...
<body class="bg-gray-100">
    <div x-data="{ open: false }" class="flex">
        ...
        <!-- Sidebar -->
        <div class="w-56 lg:pt-20 bg-white shadow-lg min-h-screen fixed lg:relative z-50 lg:z-0 transform -translate-x-full lg:translate-x-0 transition-transform duration-300 ease-in-out" :class="open ? 'translate-x-0' : '-translate-x-full'">
            <div class="p-4">
